...
The distributable is **`AutoEditorModv1.3-Android.zip`** (built on a dev machine with
...
### 4. Put `AutoEditorModv1.3-Android.zip` in Downloads
Copy/transfer `AutoEditorModv1.3-Android.zip` to the phone's **Download** folder (WhatsApp,
